...
In this scenario, we see that the odds ratio is 1.05, but the p-value
for the null hypothesis: $H_0: p_{1,1} = p_{1,2}$ is zero, indicating
that the effect of gender on the admission is statistically significant.
...
confidence interval, which we can see is $[1.017, 1.77]$. This tells
