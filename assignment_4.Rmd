...
tm <- rpart(v2 ~.,method = "class", data=data4, parms = list(split = "information"), cp = 0.1)
...
```{r}
tm_full <- rpart(v2 ~.,method = "class", data=data4, parms = list(split = "information"), cp = 0.1)

tm_chosen <- rpart(v2 ~ v3 + v7 + v11 + v14 + v17 + v18 + v21 ,method = "class", data=data4, parms = list(split = "information"), cp = 0.1)
  
tm_simple <- rpart(v2 ~ v21 ,method = "class", data=data4, parms = list(split = "information"), cp = 0.1)

rpart.plot(tm_full, digits=3)
rpart.plot(tm_chosen, digits=3)
rpart.plot(tm_simple, digits=3)
```
